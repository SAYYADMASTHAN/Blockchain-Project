          ...
          <div class="post_content">
           <form action="B_Authentication.jsp" method="post" id="leavereply">
            <ol>
              ...
              <li></li>
              <li><br />
                <a href="B_Brad_Register.html">REGISTER</a>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><strong><a href="P_Physician_Login.jsp">Physician </a></strong></li>
            <li><strong><a href="HospitalServer.jsp">Hospital</a></strong></li>
            <li><strong><a href="B_Brad_Login.jsp">Brad</a></strong></li>
          </ul>
        </div>
      </div>
      <div class="clr"></div>
