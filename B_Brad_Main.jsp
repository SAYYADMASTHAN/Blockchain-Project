...
<div class="main">
    ...
    <div class="header_resize">
      <div class="menu_nav">
        <ul>
          ...
          <li><a href="PhysicianServer.jsp"><span>Hospital</span></a></li>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span> Brad:: <%=application.getAttribute("uname") %></span></h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu style3">
			...
			<li><a href="B_Upload.jsp">Read Sensor Data and Upload</a></li>
			<li><a href="B_Views_All_Medication_Transactions.jsp">Views All Medication Transactions</a></li>
