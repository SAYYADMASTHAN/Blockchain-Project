    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <form action="B_Upload2.jsp" method="post">
            <p>
              <%
      	try {
			...
			String query1="select * from Patient_Records  where fname='"+file+"' "; 
...
%>
            ...
            <table width="545" border="1.5" cellpadding="0" cellspacing="0" align="center">
              ...
              <tr>
                <td bgcolor="#FF0000"><div align="left" class="style30">Select Patient Record Sensitive Level  </div></td>
...
%>
          ...
          <div align="right"><a href="B_Brad_Main.jsp">Back</a></div>
        </div>
        <p class="pages">&nbsp;</p>
      </div>
      <div class="sidebar">
