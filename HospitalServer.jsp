...
<div class="main">
      ...
      <div class="menu_nav">
        <ul>
          <li class="active"><a href="index.html"><span>Home Page</span></a></li>
            ...
            <li><a href="P_Physician_Login.jsp">Physician </a></li>
            <li><a href="HospitalServer.jsp">Hospital</a></li>
            <li><a href="B_Brad_Login.jsp">Brad</a></li>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>WELCOME TO Hospital LOGIN </span></h2>
