...
.style25 {font-size: 14px; color: #f3fcff; }
.style27 {
	color: #FFFFFF;
	font-weight: bold;
}
...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          <li class="active"><a href="P_Physician_Main.jsp"><span>Physician</span></a></li>
          <li><a href="P_Physician_Login.jsp"><span>Logout</span></a></li>
        </ul>
      </div>
      <div class="clr"></div>
      <div class="slider">
...
try 
	{
      		...
      		String query="Select * from patient_records where fname='"+fname+"'"; 
			...
			if ( rs.next() )
			{
					...
					s12=new String(Base64.decode(rs.getString(15)));
						...
						%>
						<form id="form1" name="form1" method="post" action="P_Provide_soln.jsp?rname=<%=s2%>&pname=<%=s7%>">
            <table width="568" border="1.5" cellpadding="0" cellspacing="0" align="center">
			  ...
			  <tr>
			   ...
			   <tr>
                 <td height="70" bgcolor="#FF0000"><div align="center" class="style27">Solution</div></td>
			     <td><textarea name="soln" cols="30" rows="5"></textarea></td>
		      </tr>
			   <tr>
			     <td height="70" bgcolor="#FF0000">&nbsp;</td>
			     <td>
			       <input type="submit" name="Submit" value="Provide Solution" />
