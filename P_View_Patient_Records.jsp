    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <div class="clr"></div>
          <div class="article">
            <table width="512" border="1.5" cellpadding="0" cellspacing="0"  align="center">
              <tr>
                ...
                <td width="99" bgcolor="#FF0000"><div align="center" class="style25">Brad Name </div></td>
                <td width="112" bgcolor="#FF0000"><div align="center" class="style25">Date &amp; Time </div></td>
                <td width="112" bgcolor="#FF0000"><div align="center" class="style25">View </div></td>
                <%	  
...
try 
	{
	        String status="waiting";
      		...
      		String query="Select *from patient_records where soln='"+status+"' "; 
			...
			while ( rs.next() )
			{
              ...
              <tr>
                ...
                <td><div align="center" class="style26"><a href="P_View_More_Details.jsp?fname=<%=s2%>">View More ...</a></div></td>
                <%
