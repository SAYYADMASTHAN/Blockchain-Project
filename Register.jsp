...
<%
					...
					try {
						...
						//image = image.replace(".", "_b.");
			 			String query1="select * from Physician  where name='"+uname+"'"; 
					...
					if ( rs1.next() )
					   ...
					   {
						PreparedStatement ps=connection.prepareStatement("insert into Physician(name,pass,email,mobile,addr,dob,gender,pin,location,imagess) values(?,?,?,?,?,?,?,?,?,?)");
